...
function Sidebar() {
    ...
    return (
        ...
        >
            ...
            >
                <Link href="/admin/users" width="100%">
                    <Button
                        colorScheme="teal"
                        variant="ghost"
                        isActive={router.pathname == '/admin/users' ? true : ''}
                        width="100%"
                        fontSize="sm"
                        rounded="lg"
                        d="flex"
                ...
                <Link href="/admin/forms" width="100%">
                    <Button
                        isActive={router.pathname == '/admin/forms' ? true : ''}
                        width="100%"
                        fontSize="sm"
                        rounded="lg"
                        colorScheme="teal"
            ...
            >
                <Button
                    isActive={router.pathname == '/admin/schedule' ? true : ''}
                    d="flex"
                    colorScheme="teal"
                    variant="ghost"
                    justifyContent="flex-start"
                ...
                <Link href="/admin/faq" width="100%">
                    <Button
                        colorScheme="teal"
                        variant="ghost"
                        isActive={router.pathname == '/admin/faq' ? true : ''}
                        width="100%"
                        fontSize="sm"
                        rounded="lg"
                        d="flex"
